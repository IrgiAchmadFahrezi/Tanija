    ...
    <div class="container mt-5 text-center">
      ...
      <div class="card feature-card mt-4">
          <div class="card-body">
              <div class="row">
                  <div class="col-md-4">
                      <i class="bi bi-truck fs-1"><img src="./src/assets/icons/box-tick.png" alt=""></i>
                      <h5 class="card-title">Pengiriman Cepat</h5>
                      <p class="card-text">Pengiriman cepat dan terjamin aman</p>
                  </div>
                  <div class="col-md-4">
                      <i class="bi bi-award fs-1"><img src="./src/assets/icons/crown.svg" alt=""></i>
                      <h5 class="card-title">Kualitas Terbaik</h5>
                      <p class="card-text">Kualitas terbaik dengan harga yang terjangku</p>
                  </div>
                  <div class="col-md-4">
                      <i class="bi bi-shield-check fs-1"><img src="./src/assets/icons/shield-security.png" alt=""></i>
                      <h5 class="card-title">Jangkauan Luas</h5>
                      <p class="card-text">Menjangkau hampir seluruh daerah di Indonesia</p>
                  </div>
              </div>
          </div>
      </div>
          ...
          <div class="content-top d-flex justify-content-between flex-column flex-lg-row">
            ...
            <div class="content-top-right subtext col-12 col-lg-7 d-flex justify-content-between flex-column flex-lg-row">
              <div class="subtext-menu">
                ...
                <div class="wrap">
                  <a href="./src/html/product.php?kategori%5B%5D=Pupuk" class="nav-link">Pupuk</a>
                  <a href="./src/html/product.php?kategori%5B%5D=Alat+Pertanian" class="nav-link">Alat Pertanian</a>
                  <a href="./src/html/product.php?kategori%5B%5D=Bibit+Tanaman" class="nav-link">Bibit Pertanian</a>
                  <a href="./src/html/product.php?kategori%5B%5D=Pestisida" class="nav-link">Pestisida</a>
                </div>
              </div>
              <div class="subtext-menu">
                <h5 class="subtext-menu-subtitle">Tentang</h5>
                <div class="wrap">
                  <a href="./src/html/about.php" class="nav-link">Tentang Kami</a>
                  <a href="./src/html/about.php" class="nav-link">FAQ</a>
                  <a href="./src/html/about.php" class="nav-link">Tim Kami</a>
                </div>
              </div>
              <div class="subtext-menu">
    ...
    <script>
        ...
        const fetchAvatar = async () => {
            try {
                ...
                return data.results[0].picture.medium; // URL foto profil dari RandomUser.me
            } catch (error) {
                console.error('Error fetching avatar:', error);
                return 'default-avatar.png'; // URL default avatar jika gagal
            }
        };
