...
<head>
    ...
    <title>Hasil Pencarian - Tanija</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../html/favorite.php"><i class="far fa-heart"></i><span class="badge"><?php echo $favoriteCount; ?></span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../html/cart.php"><i class="fas fa-shopping-cart"></i> Keranjang <span class="badge"><?php echo $cartCount; ?></span></a>
                </li>
                <li class="nav-item">
                <?php
  ...
  <nav class="navbar navbar-expand" id="navbar-kedua">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSecond">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../html/riwayat_pemesanan.php">Riwayat</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../html/article.php">Artikel</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../html/about.php">Tentang Kami</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <main>
        <div class="container my-5">
            <h1>Hasil Pencarian untuk "<?php echo htmlspecialchars($search_query); ?>"</h1>
            <div class="row">
                <?php
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4">
                                <img src="../uploads/<?php echo $row['foto_produk']; ?>" class="card-img-top" alt="<?php echo $row['nama_produk']; ?>">
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo $row['nama_produk']; ?></h5>
                                    <p class="card-text">Rp<?php echo $row['harga_produk']; ?></p>
                                    <a href="../html/detail-product.php?id=<?php echo $row['id_produk']; ?>" class="btn btn-primary">Detail</a>
                                </div>
                            </div>
                        </div>
                        <?php
