...
<head>
    ...
    <title>Kebijakan Privasi - Tanija</title>
    ...
    <link rel="stylesheet" href="../css/kebijakan-privasi.css">
    <!-- Font -->
...
<nav class="navbar navbar-expand-lg navbar-light">
  ...
  <main>
    <div class="container mt-5 isi">
      ...
      <p>Selamat datang di Tanija! Kami menghargai privasi Anda dan berkomitmen untuk melindungi informasi pribadi Anda. Kebijakan privasi ini menjelaskan bagaimana kami mengumpulkan, menggunakan, dan melindungi informasi yang Anda berikan saat menggunakan situs web kami.</p>
      
      <h2 class="mt-4">Informasi yang Kami Kumpulkan</h2>
      <p>Kami dapat mengumpulkan informasi pribadi yang Anda berikan secara sukarela saat mendaftar akun, melakukan pembelian, atau berinteraksi dengan situs web kami. Informasi yang mungkin kami kumpulkan termasuk nama, alamat email, alamat pengiriman, nomor telepon, dan informasi pembayaran.</p>
      
      <h2 class="mt-4">Bagaimana Kami Menggunakan Informasi Anda</h2>
      ...
      <ul>
        ...
        <li>Menanggapi pertanyaan dan permintaan dukungan pelanggan Anda</li>
        <li>Memberikan informasi tentang produk dan promosi yang mungkin menarik bagi Anda</li>
        <li>Meningkatkan pengalaman pengguna kami</li>
      </ul>
      
      <h2 class="mt-4">Bagaimana Kami Melindungi Informasi Anda</h2>
      <p>Kami mengambil langkah-langkah keamanan yang sesuai untuk melindungi informasi pribadi Anda dari akses yang tidak sah, penggunaan, atau pengungkapan yang tidak sah. Informasi Anda disimpan secara aman dan hanya diakses oleh staf yang berwenang.</p>
      
      <h2 class="mt-4">Pemberian Akses dan Kontrol atas Informasi Anda</h2>
      <p>Anda memiliki hak untuk mengakses, memperbarui, atau menghapus informasi pribadi Anda yang disimpan oleh kami. Jika Anda ingin mengubah atau menghapus informasi Anda, silakan hubungi kami melalui informasi kontak yang tersedia di bagian bawah halaman ini.</p>
      
      <h2 class="mt-4">Perubahan pada Kebijakan Privasi</h2>
      <p>Kami dapat memperbarui kebijakan privasi ini dari waktu ke waktu sesuai dengan perubahan dalam praktik informasi kami. Perubahan akan berlaku segera setelah diposting di halaman ini. Anda disarankan untuk secara rutin memeriksa halaman ini untuk pembaruan.</p>
      
      <h2 class="mt-4">Hubungi Kami</h2>
      <p>Jika Anda memiliki pertanyaan atau kekhawatiran tentang kebijakan privasi ini, atau jika Anda ingin mengakses, memperbarui, atau menghapus informasi pribadi Anda, silakan hubungi kami melalui:</p>
      <ul>
      ...
      <p>Terima kasih atas kepercayaan Anda pada Tanija!</p>
    </div>
  </main>
  <!-- footer -->
  <footer class="footer">
