...
<body>
  ...
  <section class="section-header">
    <div class="container">
      <div class="subtext d-flex align-items-center justify-content-between flex-column flex-lg-row">
        <div class="col-12 col-lg-6 subtext-image" data-aos="fade-left">
          <img src="../../assets/icons/logo-tanija.png" alt="" class="img" />
        </div>
        <div class="col-12 col-lg-6 subtext-text">
          <h1 class="subtext-text-display" data-aos="fade-right">Tentang Kami</h1>
          <p class="subtext-text-desc" data-aos="fade-right">
            Tanija adalah platform belanja online yang berfokus pada produk-produk pertanian berkualitas. Kami hadir untuk memberikan kemudahan bagi para petani dan konsumen dalam mendapatkan berbagai kebutuhan pertanian, mulai dari pupuk, alat pertanian, bibit, hingga pestisida. Dengan semangat untuk mendukung pertanian yang lebih maju dan berkelanjutan, Tanija berkomitmen untuk menjadi mitra terpercaya bagi semua yang terlibat dalam sektor pertanian.
          </p>
        </div>
      </div>
    </div>
  ...
  <section class="section-choose">
    <div class="container d-flex flex-column">
      <div class="content-top subtext d-flex flex-column">
        <div class="subtext-text">
          <h2 class="subtext-text-display" data-aos="fade-up">Visi dan Misi</h2>
        </div>
      </div>
      <div class="content-bottom d-flex flex-column">
        <div class="subtext-text d-flex flex-column gap-2">
          <h3 class="subtext-text-subtitle" data-aos="fade-up">Visi</h3>
          <p class="subtext-text-desc" data-aos="fade-up">
            Menjadi platform e-commerce terdepan yang menyediakan produk berkualitas tinggi dan terpercaya dalam mendukung pertanian berkelanjutan di Indonesia.
          </p>
        </div>
  ...
  <!-- team -->
  <section class="section-team" id="teams">
    <div class="container">
  ...
  <!-- description -->
  <section class="section-description" id="FAQ">
      ...
      <div id="accordion">
        <div class="card">
          <div class="card-header" id="headingOne">
            <h5 class="mb-0">
              <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
               1. Bagaimana cara mendaftar di Tanija? <span id="iconOne" class="icon-faq-1">+</span>
              </button>
            </h5>
          </div>
          ...
          <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
            <div class="card-body">
              Anda bisa mendaftar di Tanija dengan mengklik tombol "Daftar" di halaman utama dan mengisi formulir pendaftaran dengan informasi yang diperlukan.
            </div>
          </div>
        </div>
        <div class="card">
          <div class="card-header" id="headingTwo">
            <h5 class="mb-0">
              <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                2. Berapa lama waktu pengiriman produk? <span id="iconTwo" class="icon-faq-2">+</span>
              </button>
            </h5>
          </div>
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
            <div class="card-body">
              Waktu pengiriman produk bervariasi tergantung lokasi pengiriman. Biasanya, produk akan sampai dalam waktu 2-5 hari kerja.
            </div>
          </div>
        </div>
        <div class="card">
          <div class="card-header" id="headingThree">
            <h5 class="mb-0">
              <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                3. Apakah Tanija menyediakan layanan pengembalian produk? <span id="iconThree" class="icon-faq-3">+</span>
              </button>
            </h5>
          </div>
          <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
            <div class="card-body">
              Ya, Tanija menyediakan layanan pengembalian produk jika produk yang diterima dalam kondisi rusak atau tidak sesuai dengan pesanan. Silakan hubungi layanan pelanggan kami untuk informasi lebih lanjut.
            </div>
          </div>
        </div>
        <div class="card">
          <div class="card-header" id="headingFour">
            <h5 class="mb-0">
              <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseThree">
                4. Apakah Tanija menyediakan pengiriman ke seluruh Indonesia? <span id="iconFour" class="icon-faq-4">+</span>
              </button>
            </h5>
          </div>
          <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
            <div class="card-body">
              Ya, kami menyediakan layanan pengiriman ke berbagai daerah di Indonesia. Kami bekerja sama dengan berbagai jasa pengiriman untuk memastikan produk sampai ke tangan Anda dengan cepat dan aman.
            </div>
          </div>
        </div>
        <div class="card">
          <div class="card-header" id="headingFive">
            <h5 class="mb-0">
              <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseThree">
                5. Bagaimana cara menghubungi layanan pelanggan Tanija? <span id="iconFive" class="icon-faq-5">+</span>
              </button>
            </h5>
          </div>
          <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordion">
            <div class="card-body">
              Anda dapat menghubungi layanan pelanggan kami melalui email di support@tanija.com atau melalui WhatsApp di nomor +62 812-3456-7890. Layanan pelanggan kami siap membantu Anda setiap hari dari pukul 08:00 - 20:00 WIB.
            </div>
          </div>
        </div>
      </div>
