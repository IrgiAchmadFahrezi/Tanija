...
<body>
    ...
    <main class="container mt-5 mb-5">
        <div class="row">
            <div class="col-md-5 review-sec" style="max-height: 530px;">
                ...
                <form action="../php/submit_review.php" method="post" class="review" onsubmit="return validateForm()">
            ...
            <div class="col-md-5 detail-prod" style="max-height: 530px;">
                ...
                <img src="../uploads/<?= $produk['foto_produk'] ?>" class="card-img-top foto-produk" alt="<?= $produk['nama_produk'] ?>">
                    <div class="card-body">
  ...
  <footer class="footer">
    ...
    function validateForm() {
        var ratingInputs = document.getElementsByName('review_rating');
        var isChecked = false;
