      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="card">
            ...
            <button class="btn btn-warning mt-3 w-100" id="pay-button">Lanjut ke Pembayaran</button>
            </div>
          </div>
        </div>
      </div>
...
document.getElementById('pay-button').onclick = function(){
    // Minta token transaksi dari server
        ...
        .then(data => {
            if (data.token) {
                ...
                snap.pay(data.token, {
                    ...
                    onClose: function() {
                        // Handle jika popup ditutup tanpa menyelesaikan pembayaran
